        ...
        <div className="min-h-screen bg-gray-900 text-white p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    >
                        <h3 className="text-xl font-bold text-gray-200 group-hover:text-yellow-400 transition-colors">User & Service Management</h3>
                        <p className="text-gray-500 mt-2 text-sm">Manage users, permissions, and service partners.</p>
                    </div>
                    <div 
                        className="bg-gray-800 p-6 rounded-2xl border border-gray-700 hover:border-yellow-500/50 transition-all cursor-pointer group"
